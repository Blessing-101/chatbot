...
bot_greetings = ['Hello user, I am UFO, a creation of Blessedswissbox...how can I help you?',
...
st.markdown("<h4 style = 'margin: -30px; color: #F11A7B; text-align: center; font-family: cursive '>Built By Rejoice</h4>", unsafe_allow_html = True)
